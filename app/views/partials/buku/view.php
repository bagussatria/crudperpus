        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">View  Buku</h3>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> Tanggalmasuk :</th>
                                        <td class="value"> <?php echo $data['tanggalmasuk']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> Fotobuku :</th>
                                        <td class="value"><?php Html::page_img($data['fotobuku'],400,400); ?></td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("buku/edit/$data[id]"); ?>">
                                <i class="fa fa-edit"></i> 
                            </a>
                            
                            
                            <a class="btn btn-sm btn-danger recordDeletePromptAction"  href="<?php print_link("buku/delete/$data[id]"); ?>" >
