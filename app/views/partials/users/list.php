                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td><?php Html::page_img($data['fotoprofile'],50,50); ?></td>
                                                    <td> <?php echo $data['tanggalregist']; ?> </td>
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-danger recordDeletePromptAction has-tooltip" title="Delete this record" href="<?php print_link("users/delete/$data[id]"); ?>" >
                                    ...
                                    <div class="card-footer">
                                        <div class="row">   
                                            <div class="col-sm-3">  
                                                ...
                                                <button data-prompt-msg="Are you sure you want to delete these records" data-url="<?php print_link("users/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
